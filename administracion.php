...
<div id="container">
    ...
    <div class="opciones">
      <?php
          ...
          echo "<a href='administrar.php'><div class='opcion'><br>Administrar Incidencias -Estadistica</div></a>";
          echo "<a href='administrar_recursos.php'><div class='opcion'><br>Administrar Recursos</div></a>";
         echo "<a href='administrar_usuarios.php'><div class='opcion'><br>Administrar Usuarios</div></a>";
      ?>
      </div>
